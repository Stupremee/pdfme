import { z } from 'zod';
import type { PDFPage, PDFDocument } from '@stupremee/pdf-lib';
 ...
 * @property {typeof import('@stupremee/pdf-lib')} pdfLib The pdf-lib library used for rendering.
...
export interface PDFRenderProps<T extends Schema> {
  ...
  schema: T;
  basePdf: BasePdf;
  pdfLib: typeof import('@stupremee/pdf-lib');
  pdfDoc: PDFDocument;
  page: PDFPage;
