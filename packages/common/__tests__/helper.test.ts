...
describe('checkGenerateProps', () => {
  ...
  test('throws for invalid template structure', () => {
    ...
    expect(() => checkGenerateProps(invalidProps)).toThrow("[@stupremee/common] Invalid argument:\n" +
      "--------------------------\n" +
  ...
  test('throws for missing required template field and empty inputs', () => {
    ...
    expect(() => checkGenerateProps(missingSchemaProps)).toThrow("[@stupremee/common] Invalid argument:\n" +
      "--------------------------\n" +
      "ERROR POSITION: template.schemas\n" +
      "ERROR MESSAGE: Required\n" +
      "--------------------------\n" +
  ...
  test('throws for invalid plugin definitions', () => {
    ...
    expect(() => checkGenerateProps(invalidPluginProps)).toThrow("[@stupremee/common] Invalid argument:\n" +
      "--------------------------\n" +
  ...
  test('fail test: no fallback font', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@stupremee/common] fallback flag is not found in font. true fallback flag must be only one.
Check this document: https://pdfme.com/docs/custom-fonts#about-font-type`
  ...
  test('fail test: too many fallback font', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@stupremee/common] 2 fallback flags found in font. true fallback flag must be only one.
Check this document: https://pdfme.com/docs/custom-fonts#about-font-type`
      );
    }
  });
  ...
  test('fail test: fontName in Schemas not found in font(single)', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@stupremee/common] NotoSans2 of template.schemas is not found in font.
Check this document: https://pdfme.com/docs/custom-fonts`
  ...
  test('fail test: fontName in Schemas not found in font(single)', () => {
    ...
    try {
      ...
      expect(e.message).toEqual(
        `[@stupremee/common] NotoSans2,NotoSerif2 of template.schemas is not found in font.
Check this document: https://pdfme.com/docs/custom-fonts`
      );
    }
  });
...
describe('checkPlugins test', () => {
  ...
  test('fail test: type in Schemas not found in plugins(single)', () => {
    try {
      ...
      expect(e.message).toEqual(
        `[@stupremee/common] fail of template.schemas is not found in plugins.`
      );
    }
  });
  test('fail test: type in Schemas not found in plugins(multiple)', () => {
    try {
      ...
      expect(e.message).toEqual(
        `[@stupremee/common] fail,fail2 of template.schemas is not found in plugins.`
      );
    }
  });
});
