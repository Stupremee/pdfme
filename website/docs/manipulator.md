...
The `@stupremee/manipulator` package provides powerful utilities for manipulating PDF files. It can be used in both Node.js and browser environments.
...
- Invalid page numbers: `[@stupremee/manipulator] Invalid page number`
- Invalid rotation degrees: `[@stupremee/manipulator] Rotation degrees must be a multiple of 90`
- Invalid positions: `[@stupremee/manipulator] Invalid position`
- Empty inputs: `[@stupremee/manipulator] At least one PDF is required`
...
If you have any questions or suggestions about `@stupremee/manipulator`, please reach out via:
